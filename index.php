...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
  <a class="navbar-brand" ><img src="img\89.png" style="width: 70px; height: 40px;"></a>
...
<br>
<br>
<div class="Email_main" id="Email_main">
  <div class="input_Email" >
    Jewels Shop
<div class="input-group mb-3">
<form onsubmit="check();">
  <input type="text" class="form-control" placeholder="Email Address" aria-label="Recipient's username" aria-describedby="basic-addon2" id="email" style="background:transparent; color: #fff"></form>
  <div class="input-group-append">
    <button class="input-group-text" id="basic-addon2" onclick="send(event)" style="background-color: red; color: black">Go</button>
  </div>
</div>
<div id="radio_button">
...
<script>
  ...
  function my()
    ...
    function send(event) {
        ...
        Email.send({
          Host : "smtp.gmail.com",
          Username : "yash123.ajmer@gmail.com",
          Password : "yash8000maheshwari",
          To : document.getElementById('email').value,
          From : document.getElementById('email').value,
          Subject : "",
          Body : "Thanks to visit our website"
